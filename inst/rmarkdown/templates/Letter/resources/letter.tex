...
\begin{tabular}{@{}ll@{}}
      ...
      \faicon{envelope}   & aaron.conway@utoronto.ca\\
...
\setstretch{$spacing$}
$body$
\closing{$closing$\\[0.2cm]\hspace*{0.5cm}\includegraphics[height=1.5cm]{signature.jpg}\\
\parbox{10cm}{\fontsize{10}{12}\sffamily\color[gray]{0.4}
{\large\textbf{Aaron Conway}}\\
BN(Hons), PhD\\
\textit{RBC Chair in Cardiovascular Nursing Research}\\
Univeristy Health Network\\[0.2cm]
\textit{Assistant Professor}\\
Lawrence S. Bloomberg Faculty of Nursing\\
University of Toronto\\[0.2cm]
\begin{tabular}{@{}ll@{}}
      \faicon{home}       & aaronconway.info\\
      \faicon{envelope}   & aaron.conway@utoronto.ca\\
      \faicon{phone}      & +1 (416) 946-7112
