...
\multicolumn{2}{@{}l}{Peter Munk Cardiac Centre}\\
\multicolumn{2}{@{}l}{University Health Network}\\
\multicolumn{2}{@{}l}{Toronto, Canada.}\\[0.2cm]
\end{tabular}}}
...
\setstretch{$spacing$}
$body$
\closing{$closing$\\[0.2cm]\hspace*{0.5cm}\includegraphics[height=1.5cm]{signature.jpg}\\Aaron Conway\\Peter Munk Cardiac Centre\\University Health Network}
